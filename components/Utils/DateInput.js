...
import LineLoader from "../CountrySideTheme/Loaders/lineloader";
// import info from '../'
      ...
      <div data-testid="child0" className="relative w-full mb-3">
        ...
        <div data-testid="inputfield" className={visible === 1 ? "block" : "hidden"}>
          <input data-testid="inputdate"
            ...
            className={`shadow-sm ${color?.greybackground} bg-custom-dark-green  border border-custom-yellow ${color?.text} sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5`}
